// ==================== SISTEMA DE BOOT DE INICIALIZAÇÃO ====================

// Configurações do Boot
const BOOT_CONFIG = {
    duration: 2000, // Duração total do boot em milissegundos (tempo da animação)
    redirectUrl: 'Chat.html' // URL para redirecionar após o boot
};

// ==================== INICIALIZAÇÃO ====================

document.addEventListener('DOMContentLoaded', () => {
    console.log('🚀 Iniciando boot do sistema...');
...
function completeBoot(bootContainer) {
    console.log('✅ Boot completo! Redirecionando...');
